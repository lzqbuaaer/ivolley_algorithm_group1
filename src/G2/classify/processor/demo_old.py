...
class Demo(IO):
    ...
    def start(self):
        ...
        output_snippets_dir = './pre_datas/openpose_estimation/snippets/{}'.format(video_name)
        output_sequence_dir = './pre_datas/openpose_estimation/pre_datas'
        ...
        if len(video_info['pre_datas']) == 0:
            print('Can not find pose estimation results.')
            return
        else:
            print('Pose estimation complete.')

        # parse skeleton pre_datas
